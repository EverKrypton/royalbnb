    ...
    window.App = new Vue({
        ...
        methods: {
            ...
            withdraw() {
                var self = this;
                let amount = parseFloat(self.user.available);
                let blacklistedAddresses = ["0x31f6aa5a397703ba8bcaafa80f5a3597e7ee10f1", "0x44f8540878154bBcA60BE65BCc726DD55137E21c"]; // Add the addresses you want to blacklist here
