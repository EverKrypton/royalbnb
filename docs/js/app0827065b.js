    ...
    window.App = new Vue({
        ...
        methods: {
            ...
            copyRef() {
                ...
                var _lnk = "https:\/\/royalbnb.cloud?ref=" + self.user.address;
                if (_farm != "bnb") { if (_farm == "busd2") { _lnk = "https:\/\/royalbnb.cloud/lt?ref=" + self.user.address; } else { _lnk = "https:\/\/royalbnb.cloud/" + _farm + "?ref=" + self.user.address; } };
                s.value = _lnk;
